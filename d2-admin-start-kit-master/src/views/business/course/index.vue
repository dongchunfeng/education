    ...
    <el-row>
      <el-col :span="6" v-for="o in tableData" :key="o.id">
        <el-card :body-style="{ padding: '0px' }">
          <img v-show="!o.image" src="./../../../../public/image/demo-course.jpg" class="image">
          ...
          <div style="padding: 14px;">
            ...
            <span style="color:#409EFF;font-size:25px;font-weight:200">{{o.name}}</span>
...
export default {
    ...
    created(){
     ...
     data() {
      return {
        COURSE_LEVEL:[{value:"1", label:"初级"},{value:"2", label:"中级"},{value:"3", label:"高级"}],
        COURSE_CHARGE:[{value:"C", label:"收费"},{value:"F", label:"免费"}],
        COURSE_STATUS:[{value:"P", label:"发布"},{value:"D", label:"草稿"}],
        visible: false,
        title:"",
        ruleForm: {
            "id":'',
        ...
        rules: {
            ...
            "image": [
                { required: false, message: '请选择封面', trigger: 'change' }
            ],
            "level": [
